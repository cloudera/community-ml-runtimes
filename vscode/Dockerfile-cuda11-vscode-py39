...
FROM docker.repository.cloudera.com/cloudera/cdsw/ml-runtime-pbj-workbench-python3.9-cuda:2023.08.2-b8
...
ENV ML_RUNTIME_EDITOR="VsCode" \
    ...
    ML_RUNTIME_FULL_VERSION="2023.11.2" \
    ML_RUNTIME_DESCRIPTION="This runtime includes VsCode editor v4.16.1 and is based on PBJ Workbench image with Python 3.9 and CUDA 11"
